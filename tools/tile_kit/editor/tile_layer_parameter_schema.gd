...
const DEFINITIONS := {
	...
	"dressing": {
		...
		"description": "Flat organic patches used for moss, soil, mud, or colour breakup.",
	...
	"clutter": {
		...
		"parameters": [
			...
			{"section": "DISTRIBUTION", "key": "count", "label": "Amount",
	...
	"grass_clusters": {
		...
		"defaults": {"coverage_mode": "carpet", "carpet_spacing": 0.315,
		...
		"parameters": [
			{"section": "CARPET MODE", "key": "coverage_mode", "label": "Composition",
				"type": "enum", "values": ["carpet", "clusters"], "randomize": false},
